...
private:
    ...
    UI*             m_SelectInst; //Delegate함수를 쓰기 위한 객체
    UI_DELEGATE_1   m_SelectFunc; //Delegate 함수는 ImguiMgr에서 정의함
...
public:
    ...
    //void SetRightClickActivate(bool _active) { m_bIsRightClickActivated = _active; }
private:

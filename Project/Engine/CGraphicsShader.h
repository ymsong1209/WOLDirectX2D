...
private:
    ...
    //bool                            m_bScalarParam[(UINT)SCALAR_PARAM::MAT_3 + 1];
    //bool                            m_bTexParam[(UINT)TEX_PARAM::TEX_END];
...
public:
    ...
    void AddScalarParam(SCALAR_PARAM _Param, const string& _desc);
    ...
    //bool  GetboolScalarParam() { return m_bScalarParam; }

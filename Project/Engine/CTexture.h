...
public:
    ...
    int            GetScratchWidth() { return m_Image.GetMetadata().width; }
    int            GetScratchHeight() { return m_Image.GetMetadata().height; }
    unsigned char* GetScratchPixelData() { return m_Image.GetPixels(); }

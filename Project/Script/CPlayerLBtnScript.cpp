...
CPlayerLBtnScript::CPlayerLBtnScript()
	:CScript((UINT)SCRIPT_TYPE::PLAYERLBTNSCRIPT)
{
}
...
void CPlayerLBtnScript::begin()
{
	MeshRender()->GetDynamicMaterial();
}

void CPlayerLBtnScript::tick()
{
	...
	PLAYER_SKILL Skill = PlayerMainScript->GetLBtnSkill();
	m_fCoolTime = PlayerMainScript->GetLBtnCoolTime();
	m_fCurCoolTime = PlayerMainScript->GetLBtnCurCoolTime();
	switch (Skill)
	{
...
void CPlayerLBtnScript::SaveToLevelFile(FILE* _File)
{
}

void CPlayerLBtnScript::LoadFromLevelFile(FILE* _File)
{
	MeshRender()->GetDynamicMaterial();

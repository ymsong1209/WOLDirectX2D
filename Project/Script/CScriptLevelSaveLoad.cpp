...
int CScriptLevelSaveLoad::SaveLevel(const wstring& _LevelPath, CLevel* _Level)
{
...
int CScriptLevelSaveLoad::SaveGameObject(CGameObject* _Object, FILE* _File)
{
	// 이름
...
CLevel* CScriptLevelSaveLoad::LoadLevel(const wstring& _LevelPath)
{
	wstring strPath = CPathMgr::GetInst()->GetContentPath();
	strPath += _LevelPath;
...
CGameObject* CScriptLevelSaveLoad::LoadGameObject(FILE* _File)
{
